                  ...
                  <div class="col-md-10 mt-2">
                    <div class="d-inline-flex">
                      <div class="col m-3">
                        ...
                        <img src="{{ asset($fav->image)}}" width="80%" class="d-block mx-auto">
                        </a>
                      </div>
                      <div class="col-8 m-3">
                        <div class="col"><h5 class="w-100">{{App\Models\Post::find($fav->favoriteable_id)->title}}</h5></div>
                        <div class="col"><h6 class="w-100"><div class="div-pre">{{App\Models\Post::find($fav->favoriteable_id)->content}}</div></h6></div>
